    ...
    <div className="land-root">
      ...
      <nav className="land-nav">
        ...
        <div className="nav-tabs">
          <button className="nav-tab" onClick={() => scrollTo('hero')}>Home</button>
          <button className="nav-tab" onClick={() => scrollTo('mobile-app')}>Mobile App</button>
          <button className="nav-tab" onClick={() => scrollTo('web-app')}>Web App</button>
          <button className="nav-tab" onClick={() => scrollTo('about')}>Team</button>
        </div>
      ...
      {/* HERO */}
      <main id="hero" className="land-hero">
      ...
      {/* MOBILE STRIP */}
      <section id="mobile-strip" className="mobile-strip">
        <div className="ms-left">
          ...
          <a href="/downloads/app-release.apk" download className="btn-download">
           ...
           <path d="M6 18a1 1 0 0 0 1 1h1v3.5a1.5 1.5 0 0 0 3 0V19h2v3.5a1.5 1.5 0 0 0 3 0V19h1a1 1 0 0 0 1-1V8H6v10zM3.5 8A1.5 1.5 0 0 0 2 9.5v5a1.5 1.5 0 0 0 3 0v-5A1.5 1.5 0 0 0 3.5 8zm17 0a1.5 1.5 0 0 0-1.5 1.5v5a1.5 1.5 0 0 0 3 0v-5A1.5 1.5 0 0 0 20.5 8zm-4.97-5.84l1.3-1.3a.3.3 0 0 0-.42-.42l-1.46 1.46A5.9 5.9 0 0 0 12 1.5c-.99 0-1.93.24-2.75.66L7.79.7a.3.3 0 0 0-.42.42l1.3 1.3A5.98 5.98 0 0 0 6 7h12a5.98 5.98 0 0 0-2.44-4.84zM9.5 5.25a.75.75 0 1 1 0-1.5.75.75 0 0 1 0 1.5zm5 0a.75.75 0 1 1 0-1.5.75.75 0 0 1 0 1.5z"/>
           </svg>
           <span>
      ...
      {/* WEB APP + MOBILE APP OVERVIEW */}
      <div id="web-app">
        <AppOverviewSection />
      </div>

      {/* TEAM — at the end of the page */}
      <AboutSection />

      <footer className="land-footer">
        <span>© 2026 TICKETY — Smart Queue Management</span>
